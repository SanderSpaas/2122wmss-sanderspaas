...
VALUES
	...
	(2,1,'1','Joris','Maervoet','joris.maervoet@odisee.be','+32 497 39 12 75'),
	(3,2,'1','R','Botr','',NULL),
...
CREATE TABLE `tickets` (
  ...
  CONSTRAINT `ticket_company` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`),
...
INSERT INTO `tickets` (`id`, `company_id`, `user_id`, `status`, `team`, `title`, `short_description`, `deadline`, `added_on`, `updated_on`)
VALUES
	(1,1,1,'In progress','Infra','Setup loadbalancer',NULL,'2022-01-01 00:00:00','2021-12-20 23:14:44',NULL);
